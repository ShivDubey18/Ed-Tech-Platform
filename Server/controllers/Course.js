...
//         const thumbnail = req.files.thumbnailImage;
//         console.log(courseName,courseDescription,whatYouWillLearn,price,tags,category);
...
//         //checking given category is valid or not
//         const categoryDetails= await Category.findById(category);
...
//         const uploadedThumbnail = await uploadImageOnCloudinary(thumbnail,process.env.FOLDER_NAME);

//         //creating an entry in DB for new course
//         const newCourse= await Course.create({
//             courseName,
//             courseDescription,
//             price,
...
//         //update new course to User i.e instructor
...
// exports.getCourseDetails = async(req,res)=>{
//     try{
//         //fetch courseId from req
//         const {courseId}=req.body;
//         if(!courseId){
//             return res.status(400).json({
//                 success:false,
//                 message:"Please provide courseId for operations"
//             });
//         }
//         //find courseDetails
...
//             });
//         }
//         console.log("All details of Course are: ",courseDetails);
//         //send successfull response
//         return res.status(200).json({
//             success:true,
//             message:"All details of course fetched successfully!",
//             courseDetails
//         });
//     }
//     catch(error){
//         console.log("Error occured while fetching all details of course : ",error);
//         return res.status(500).json({
//             success:false,
//             message:"Error occured while fetching all details of course",
//             error:error.message
//         });
//     }
// }
